#pragma checksum "D:\Licenta\EventWorld.Web\Views\Event\Details.cshtml" "{ff1816ec-aa5e-4d10-87f7-6f4963833460}" "96725ccc3fd0b7422a152a5bdd37cf33b8a7604c"
// <auto-generated/>
...
#line default
#line hidden
    [global::Microsoft.AspNetCore.Razor.Hosting.RazorSourceChecksumAttribute(@"SHA1", @"96725ccc3fd0b7422a152a5bdd37cf33b8a7604c", @"/Views/Event/Details.cshtml")]
...
<div class=""ew-events"" id=""event-model"">
    <div data-bind=""callFunction: getEvent"" class=""event-details-container"">
        ...
        <!-- ko if: event().creatorUserId != $(""#id"").val() && $(""#is-admin"").val() !== ""True"" -->
        <div class=""event-details-btn"">
            <button data-bind=""disable: isAjaxCallRunning, css: { 'attending' : isUserAttending }, click: attendEvent"" class=""ew-btn"">
                <div data-bind=""visible: isAjaxCallRunning"" class=""loader""></div>
        ...
        <div class=""event-details-btn"">
            <button data-bind=""disable: isAjaxCallRunning, click: approveE");
            WriteLiteral(@"vent"" class=""ew-btn approve-btn"">
                <div data-bind=""visible: isAjaxCallRunning"" class=""loader""></div>
...
");
            ...
            __tagHelperExecutionContext = __tagHelperScopeManager.Begin("script", global::Microsoft.AspNetCore.Razor.TagHelpers.TagMode.StartTagAndEndTag, "96725ccc3fd0b7422a152a5bdd37cf33b8a7604c6427", async() => {
            }
            );
